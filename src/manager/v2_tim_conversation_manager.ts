...
import type { V2TimConversationListFilter } from '../interface/v2TimConversationListFilter';
import type { V2TimConversationOperationResult } from '../interface/v2TimConversationOperationResult';
...
export class V2TIMConversationManager {
            ...
            this.conversationListenerList.forEach((listener) => {
                switch (type) {
                    ...
                    case 'onConversationGroupCreated':
                        listener.onConversationGroupCreated &&
                            listener.onConversationGroupCreated(
                                data.groupName,
                    ...
                    case 'onConversationGroupDeleted':
                        listener.onConversationGroupDeleted &&
                    ...
                    case 'onConversationsDeletedFromGroup':
                        listener.onConversationsDeletedFromGroup &&
                            listener.onConversationsDeletedFromGroup(
                                data.groupName,
                                data.conversationList
                            );
    ...
    public addConversationsToGroup(
        groupName: String,
        conversationIDList: String[]
    ): Promise<V2TimValueCallback<V2TimConversationOperationResult[]>> {
        return this.nativeModule.call(this.manager, 'addConversationsToGroup', {
            groupName,
            conversationIDList,
        });
    }

    public deleteConversationsFromGroup(
        groupName: String,
        conversationIDList: String[]
    ): Promise<V2TimValueCallback<V2TimConversationOperationResult[]>> {
        return this.nativeModule.call(
    ...
    public setConversationCustomData(
        customData: String,
        conversationIDList: String[]
    ): Promise<V2TimValueCallback<V2TimConversationOperationResult[]>> {
        return this.nativeModule.call(
    ...
    public getConversationListByFilter(
    ...
    public markConversation(
        markType: number,
        enableMark: boolean,
        conversationIDList: string[]
    ): Promise<V2TimValueCallback<V2TimConversationOperationResult[]>> {
        return this.nativeModule.call(this.manager, 'markConversation', {
            markType,
            enableMark,
            conversationIDList,
        });
    ...
    public createConversationGroup(
        groupName: string,
        conversationIDList: string[]
    ): Promise<V2TimValueCallback<V2TimConversationOperationResult[]>> {
        return this.nativeModule.call(this.manager, 'createConversationGroup', {
            groupName,
            conversationIDList,
        });
    }

    public getConversationGroupList(): Promise<V2TimValueCallback<string[]>> {
        return this.nativeModule.call(
            this.manager,
    ...
    public deleteConversationGroup(groupName: string): Promise<V2TimCallback> {
        return this.nativeModule.call(this.manager, 'deleteConversationGroup', {
            groupName,
        });
    }

    public renameConversationGroup(
        oldName: string,
        newName: string
    ): Promise<V2TimCallback> {
        return this.nativeModule.call(this.manager, 'renameConversationGroup', {
            oldName,
            newName,
        });
    }
