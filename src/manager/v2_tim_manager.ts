...
export class V2TIMManager {
     ...
     *
     */
    public subscribeUserStatus(userIDList: String[]): Promise<V2TimCallback> {
        return this.nativeModule.call(this.manager, 'subscribeUserStatus', {
            userIDList,
        });
    }
     ...
     *
     */
    public unsubscribeUserStatus(userIDList: String[]): Promise<V2TimCallback> {
        return this.nativeModule.call(this.manager, 'unsubscribeUserStatus', {
            userIDList,
        });
    }
