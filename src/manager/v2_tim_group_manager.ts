...
import type { V2TimTopicOperationResult } from 'src/interface/v2TimTopicOperationResult';
...
export class V2TimGroupManager {
     ...
     * ### 删除话题
     */
    public deleteTopicFromCommunity(
        groupID: string,
        topicIDList: string[]
    ): Promise<V2TimValueCallback<V2TimTopicOperationResult[]>> {
        return this.nativeModule.call(
            this.manager,
