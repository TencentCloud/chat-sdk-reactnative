...
const AddEventListenerComponent = () => {
    ...
    const addEventListener = async () => {
        ...
        await TencentImSDKPlugin.v2TIMManager
            ...
            .addFriendListener(FriendListenerObj);
        await TencentImSDKPlugin.v2TIMManager
            .getMessageManager()
            .addAdvancedMsgListener(advancedMsgListenerObj);
        await TencentImSDKPlugin.v2TIMManager
            .getConversationManager()
            .addConversationListener(conversationListenerObj);
        await TencentImSDKPlugin.v2TIMManager
            .getSignalingManager()
    ...
    const removeAdvanceMsgListener = () => {
        TencentImSDKPlugin.v2TIMManager
            .getMessageManager()
            .removeAdvancedMsgListener(advancedMsgListenerObj);
    };
    ...
    const removeSignalingListener = () => {
        TencentImSDKPlugin.v2TIMManager
            .getSignalingManager()
            .removeSignalingListener(signalingListenerObj);
    };
    ...
    const removeFriendListener = () => {
        TencentImSDKPlugin.v2TIMManager
            .getFriendshipManager()
            .removeFriendListener(FriendListenerObj);
    };
    ...
    const removeConversationListener = () => {
        TencentImSDKPlugin.v2TIMManager
            .getConversationManager()
            .removeConversationListener(conversationListenerObj);
    };
