            ...
            >
                ...
                >
                    <Image
                        ...
                        source={
                            styleState
                                ? require('../../icon/personblue.png')
                                : require('../../icon/persongray.png')
                        }
                    />
    ...
    return (
        ...
        >
            <View
                style={
                    styleState
                        ? mystylesheet.itemContainerblue
                        : mystylesheet.itemContainergray
                }
            >
                <Image
                ...
                <View>
                    ...
                    <TextInput
                        style={
                            styleState
                                ? mystylesheet.textInputblue
                                : value === ''
                                ? mystylesheet.textInputgray
                                : mystylesheet.textInput
                        }
                        placeholder={placeholder}
                        ref={textInputref}
                        onChangeText={(text) => {
