...
class TimJs: RCTEventEmitter {
    ...
    func call(manager: String, methodName: String, arguments: [String:Any], resolve:@escaping RCTPromiseResolveBlock,reject:RCTPromiseRejectBlock) -> Void {
		...
		case "subscribeUserStatus":
			sdkManager.subscribeUserStatus(param: arguments, resolve: resolve);
            break;
		case "unsubscribeUserStatus":
			sdkManager.unsubscribeUserStatus(param: arguments, resolve: resolve);
            break;
		...
		case "addConversationsToGroup":
			conversationManager.addConversationsToGroup(param: arguments, resolve: resolve)
			break
		case "deleteConversationsFromGroup":
			conversationManager.deleteConversationsFromGroup(param: arguments, resolve: resolve)
			break
		 case "setConversationCustomData":
            conversationManager.setConversationCustomData(param: arguments, resolve: resolve)
            break;
        case "getConversationListByFilter":
            conversationManager.getConversationListByFilter(param: arguments, resolve: resolve)
            break;
        case "markConversation":
            conversationManager.markConversation(param: arguments, resolve: resolve)
            break;
        case "createConversationGroup":
            conversationManager.createConversationGroup(param: arguments, resolve: resolve)
            break;
        case "getConversationGroupList":
            conversationManager.getConversationGroupList(param: arguments, resolve: resolve)
            break;
        case "deleteConversationGroup":
            conversationManager.deleteConversationGroup(param: arguments, resolve: resolve)
            break;
        case "renameConversationGroup":
            conversationManager.renameConversationGroup(param: arguments, resolve: resolve)
            break;
        case "invite":
